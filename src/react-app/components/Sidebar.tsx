...
const navItems = [
  ...
  { icon: CreditCard, label: "My Health Card", path: "/dashboard/health-card" },
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-border fixed h-full">
        ...
        <div className="p-4 border-t border-border">
          <Link
            to="/"
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-muted-foreground hover:bg-red-50 hover:text-red-600 transition-all"
          >
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`lg:hidden fixed top-16 left-0 bottom-0 w-64 bg-white border-r border-border z-50 transform transition-transform duration-300 ${
